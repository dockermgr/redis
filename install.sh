...
REPO="${DOCKERMGRREPO:-https://github.com/$SCRIPTS_PREFIX}/redis"
APPVERSION="$(__appversion "$REPO/raw/$REPO_BRANCH/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="redis"
export INSTDIR="$HOME/.local/share/CasjaysDev/$SCRIPTS_PREFIX/redis"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default: [redis.$SET_HOST_FULL_NAME] [$SET_HOST_FULL_DOMAIN]
CONTAINER_HOSTNAME=""
